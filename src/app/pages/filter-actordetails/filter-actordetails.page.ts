...
@Component({
  selector: 'app-filter-actordetails',
  templateUrl: './filter-actordetails.page.html',
  styleUrls: ['./filter-actordetails.page.scss'],
})
export class FilterActordetailsPage implements OnInit {
